...
- Name: content.spec.ts >> Content Create (UI form journey) >> F4: submitting with missing required fields shows a visible validation error
- Location: e2e/content.spec.ts:105:3
