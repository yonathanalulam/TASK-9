...
final class ZoneMappingCoverageTest extends WebTestCase
{
    ...
    public function testCreateZoneMappingReturns201Or422(): void
    {
        ...
        // Use a well-formed UUID v4 for the mapped entity.
        $fakeEntityId = 'a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d';

        $status = $this->api('POST', '/api/v1/delivery-zones/' . $zoneId . '/mappings', $token, [
            'mapping_type' => 'administrative_area',
            'mapped_entity_id' => $fakeEntityId,
            'precedence' => 1,
        ]);
