...
final class RetentionCoverageTest extends WebTestCase
{
    ...
    private function loginAsAdmin(): string
    {
        ...
        $suffix = 'ret_' . (++self::$counter) . '_' . bin2hex(random_bytes(4));
    ...
    public function testGetRetentionCasesReturns200(): void
    {
