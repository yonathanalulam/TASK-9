...
final class WarehouseDetailCoverageTest extends WebTestCase
{
    ...
    private function loginAsAdmin(): string
    {
        ...
        $suffix = 'whd_' . (++self::$counter) . '_' . bin2hex(random_bytes(4));
    ...
    public function testGetWarehouseLoadShowReturns404ForNonExistentId(): void
    {
